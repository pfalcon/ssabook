...
range propagation in Section~\ref{novillo:sec:vrp}. Finally, a few examples of
data flow problems will be discussed that cannot be modeled using this approach.
Dead code elimination, discussed in
Section~\ref{novillo:sec:dead_code_elimination}, is such a problem that can be
solved elegantly using SSA graphs. Section~\ref{novillo:sec:live_variables}
covers liveness analysis, which similarly profits from SSA form, even though it
cannot be modeled using the generic propagation engine via SSA graphs. We
finally conclude and provide links for further reading in
Section~\ref{novillo:sec:conclusion}.
...
\label{novillo:sec:live_variables}
...
\obacht{Citation}{Cite Benoits Liveness Sets paper}
