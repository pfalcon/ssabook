...
\label{sec:ole}
Our approach involves to associate to \emph{any} liveness query an outermost excluding loop query.
An efficient implementation of \textsf{OLE} is thus required.
