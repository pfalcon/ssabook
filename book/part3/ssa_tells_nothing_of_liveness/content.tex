...
Such a framework is well suited for tree-scan based register allocation\index{tree scan} (see Chapter~\ref{chapter:register_allocation}), SSA destruction\index{destruction, SSA} (see Chapter~\ref{chapter:alternative_ssa_destruction_algorithm}, or Hyperblock scheduling (see Chapter~\ref{chapter:machine_dependent_optimization_codegen}).
