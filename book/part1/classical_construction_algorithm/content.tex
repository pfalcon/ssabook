...
an \textit{$\phi$-web}. We recall from
Chapter \ref{chap:properties_and_flavours}
that conventional SSA is defined as a flavor under which each
$\phi$-web is interference free, i.e.\ each $\phi$-webs constituent
variables have non-overlapping live ranges.
The discovery of $\phi$-webs can be performed efficiently 
