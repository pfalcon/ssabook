\chapter{Standard Construction and Destruction Algorithms \Author{\\\strut\hfill J.~Singer \andAuthor F.~Rastello}}
...
frontiers
of distinct nodes may intersect, e.g.\ in the example CFG in Figure~\ref{fig:classical_construction_algorithm:examplecfg},
...
\caption{\label{alg:classical:renaming}Renaming algorithm for second
  phase of SSA construction}\index{renaming, of variables}
\end{algorithm}
