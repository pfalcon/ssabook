...
This gives the following pseudo-code for the variable renaming algorithm which translates our running example into the SSA form of Figure~\ref{fig:classical_construction_algorithm:examplecfg}:
