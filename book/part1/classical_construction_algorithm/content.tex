...
while worklist is non empty
  ...
  if (JS???) foreach ai such that ai \in {a1,a'}
...
These initial presentations trace the ancestry of SSA form back to the
...
seminal papers on efficient data flow analysis.
...
There are interesting dualisms between concepts in SSA form programs
and
