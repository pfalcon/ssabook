...
\ForEach{$d \in v$.defs}{
  ...
  \If{\textnormal{inst} is a \phifun}{
    ...
    \Else{
      ...
      \ForEach(\tcc*[f]{from bottom to top}){$l \in b.\mbox{defs}$ in order}{
...
\begin{procedure}
  ...
  \If{$b.\mbox{defs} \ne \emptyset$}{
  \Return{b.defs[0]}\tcc*[f]{$b$.defs[0] is the latest def. in $b$}
  }
  \Else{
