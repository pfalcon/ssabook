...
It is common to find in the literature the following definition of
  ...
  (e.g.  in~\cite{GA96,liverange.pldi02,SmithRH04}) or its refinement ``two variables interfere if one is live at a definition point of the other'' (e.g. in~\cite{Chaitin82}).  In fact, $a$ and $b$ interfere only if
...
definition -- upward exposed use analysis as developed in Chapter~\ref{chapter:liveness} is sufficient.  The
...
\else
As already mentioned in Chapter~\ref{chapter:properties_and_flavors} the ultimate notion of interference contains two dynamic (i.e., related to the
execution) notions: the notion of liveness and the notion of value.  
