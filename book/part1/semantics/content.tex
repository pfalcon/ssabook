...
called $\alpha$-renaming\index{$\alpha$-renaming}. Typically, program analyses 
for functional
...
contains $\lambda\, x .\, 2\times  x$, as in the following code:
...
\quad
\begin{array}{l}
\mathtt{let}\ k' = \lambda\, x .\, k (2\times x)\ \mathtt{in}\ f(k')\ \mathtt{end}.
\end{array}
\end{array}
\end{functional}%
