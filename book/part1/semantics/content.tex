...
Given that points of variable definition amount to binding occurrences
...
While resulting in a legal SSA program (indeed any algorithm claiming
...
%            \, \letinD x {x-1} {}}}\\ 
%            \begin{array}{lcl}\mathtt{fun}\ f_3(y,v) & = & \letin w {y+v} w\end{array}\\
%            \, \mathtt{in}\ \ite {x=0} {\call {f_2} {v,z,y}}
%                     {\call {f_3} {y,v}}\ \mathtt{end}\\
%             \mathtt{end}\ \mathtt{end}\ \mathtt{end}
%           \end{array}\\
%     \, \mathtt{in}\  {\call {f_2} {v,z,y}}\ \mathtt{end}\ \mathtt{end}\ \mathtt{end}
%   \end{array}\\
%\begin{array}{lcl}
%  \mathtt{in}\ f_1()\ \mathtt{end}
%\end{array} 
...
%    \, \letinD z 8 {
%    \, \letinD y 4 {}}}\\
%     \begin{array}{lcl}\mathtt{fun}\ f_2(y) & = & \end{array}\\
%    \, \qquad \begin{array}{l}  
%            \,  \letinD x {5+y} {
%            \, \letinD y {x*z} {
%            \, \letinD x {x-1} {}}}\\ 
%            \begin{array}{lcl}\mathtt{fun}\ f_3() & = & \letin w {y+v} w\end{array}\\
%            \, \mathtt{in}\ \ite {x=0} {\call {f_3} {}}
%                     {\call {f_2} {y}}\ \mathtt{end}\\
%             \mathtt{end}\ \mathtt{end}\ \mathtt{end}
%           \end{array}\\
%     \, \mathtt{in}\  {\call {f_2} {y}}\ \mathtt{end}\ \mathtt{end}\ \mathtt{end}
%   \end{array}\\
%\begin{array}{lcl}
%  \mathtt{in}\ f_1()\ \mathtt{end}
%\end{array} 
...
The choice as to where functions are inserted in their hosts
...
\subsubsection{A functional representation}
