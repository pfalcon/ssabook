...
goal: to represent aspects of program structure, namely the def-use\index{def-use}
...
\subsubsection{Variable assignment versus name binding}
...
An alternative transformation is to insert $f$ near the end of its
...
\end{array}
\end{equation}
Both calls to $f_3$ are in the scope of its declaration and contain
