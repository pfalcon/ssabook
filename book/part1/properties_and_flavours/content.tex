...
Still, a technique such as value numbering that is straightforward to implement under SSA (See~\ref{chapter:constant_propagation_is_easier}) can make a fairly good job, especially in the presence of a code with many variable-to-variable copies, such as one obtained after a naive 
