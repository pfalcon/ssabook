...
using a single pass that processes operations along a topological order traversal of a forward CFG\index{forward control flow graph}~\footnote{A forward control flow graph is an acyclic reduction of the CFG obtained by removing back-edges. See Section~\ref{sec}}, most definitions are processed prior to their uses. 
