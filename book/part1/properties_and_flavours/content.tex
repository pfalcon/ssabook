...
\begin{figure}
\subfloat[non-SSA program] {
  \includegraphics{du1.pdf}
}
\subfloat[SSA form program] {
  \includegraphics{du2.pdf}
}
...
\subfloat[Non-strict code] {
  \includegraphics{double-diamond1.pdf} 
}
\subfloat[SSA with dominance property] {
  \includegraphics{double-diamond2.pdf}
}
