...
\inputpath{part1}{properties_and_flavours/tikz/}
...
The notion of pruned SSA has been introduced by Choi, Cytron, and Ferrante~\cite{ChoiJan91}. The example of Figure~\ref{fig:properties_and_flavors:pruned} to illustrate the difference between pruned and non pruned SSA have been borrowed from Cytron et al.~\cite{CytronOct91}. 
