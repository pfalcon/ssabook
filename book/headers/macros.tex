...
\newcommand\false{\textrm{False}\xspace}
\newcommand\true{\textrm{True}\xspace}
\newcommand\nullprog{\textrm{Null}\xspace}

\newcommand\cidom[1]{#1.\textsf{idom}}
\newcommand\eanc[1]{#1.\textsf{eanc}}
...
\def\Defs#1{\textrm{Defs}(#1)}
\def\Def#1{\textrm{Def}(#1)}
%%%
