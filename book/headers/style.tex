...
\newif\ifconstantprop
\ifdefined\withconstantpropagation
 \constantproptrue
\else
 \constantpropfalse
\fi
...
\newif\ifregin
\ifdefined\withregisterallocation
 \regintrue
\else
 \reginfalse
\fi
...
%% "Figure" for title page: display introduction in "φ-shape"
...
\else
\newcommand\inputprogress{}
\renewcommand\progressbaraverage[2]{}
\fi
