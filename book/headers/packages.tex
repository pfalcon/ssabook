...
%Algorithms
\usepackage[ruled, linesnumbered, noend]{algorithm2e}  % algorithm2e.pdf in the book/packages directory
...
\usepackage{algorithm2e}  % algorithm2e.pdf in the book/packages directory
