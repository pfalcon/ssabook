...
\usepackage{lmodern}
%BD3 commented this package (why?)
...
%
% command 'see' is already defined and enough
...
%Algorithms
\ssausepackage[ruled, vlined, linesnumbered, algochapter]{algorithm2e}  
