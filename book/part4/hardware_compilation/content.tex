...
% YES, keep these in the text please.
...
% REPLACED with Vivado.
%\index{vivado}
%Xilinx Inc., “Vivado High-Level Synthesis,” http://www.xilinx.com/products/design- tools/vivado/integration/esl-design/index.htm, [Accessed: June 2014]. 
%Add a reference for Mentor Graphics's if you think this is appropriate.

% YES, please put the references back
...
% NO, I would leave them out. There is too much stuff already.
...
% ADDED a paragraph at the beginning on FPGAs. No references, but if you want a couple of then just add the following two:
% Intel® Arria10® Device Overview, March 15, 2017 (https://www.altera.com/products/fpga/arria-series/arria-10/features.html)


%Xilinx Inc., Virtex UltraScale+ FPGA devices (https://www.xilinx.com/products/silicon-devices/fpga/virtex-ultrascale-plus.html)
...
% I would leave that in - it is old but a base reference to SSA unless you have a more
% recent one.
...
% I think I removed the sentence altogether.
...
% OK., as long as there are references there about that issue.
