...
A common vehicle for the realization of hardware designs is a Field-Programmable Gate Arrays or FPGA. These devices include a large number of configurable logic blocks (or CLBs)
