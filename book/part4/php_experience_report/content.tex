...
techniques as discussed in Section
\ref{run-time-tables}.  The \var{eval} statement may also be handled
...
\subsection{Addition reading}

The HSSA algorithm is described further in \ref{chapter:hssa}. Array SSA
...
\ref{chapter:constant_propagation_is_easier}, and
\ref{chapter:array_ssa}.
