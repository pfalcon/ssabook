...
\begin{tikzpicture}[node distance = 1.6 cm]
    ...
    \node [rectangle, draw, below of = bb1] (bb3) {BB3};
    \node [rectangle, draw, below of = bb3]       (bb4) {BB4};
    \node [rectangle, draw, below right of = bb4] (bb5) {BB5};
    \node [rectangle, draw, below left of = bb5]  (bb6) {BB6};
    \node [rectangle, draw, below left of = bb2]       (bb4a) {BB4};
    \node [rectangle, draw, below right of = bb4a] (bb5a) {BB5};
    \node [rectangle, draw, below left of = bb5a]  (bb6a) {BB6};
    \node [rectangle, draw, below left of = bb6]  (bb7) {BB7}
    edge [out=300, in=60, looseness=2.8, ->] (bb1);
