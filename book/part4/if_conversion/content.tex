...
\centering
  \subfigure[Nested test] {
    ...
    \label{fig:hyper1}}
  \subfigure[Predicated] {
    \includegraphics[scale=0.8]{nested2.pdf}
    \label{fig:hyper2}}
  \subfigure[Speculated] {
...
\begin{figure}[h]
\centering
  \subfigure[Original loop region] {
    \includegraphics[scale=0.7]{hyper1.pdf}
    \label{fig:hyper1}}
  \subfigure[SSA if-conversion] {
    \includegraphics[scale=0.7]{hyper4.pdf}
    \label{fig:hyper2}}
  \subfigure[tail duplication] {
    \includegraphics[scale=0.7]{hyper3.pdf}
    \label{fig:hyper3}}
\caption{Tail duplication example}
\label{fig:tail_dup}
\end{figure}
