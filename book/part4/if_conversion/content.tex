...
\begin{figure}
  ...
  \includegraphics[scale=0.6]{phi_removal}
  \label{fig:phi_rem}}
  \subfloat[phi reduction] {
  \includegraphics[scale=0.6]{phi_reduction}
  \label{fig:phi_red}}
  \subfloat[phi merge] {
  \includegraphics[scale=0.6]{phi_merge}
  \label{fig:phi_merge}}
  \subfloat[phi augmentation] {
  \includegraphics[scale=0.6]{phi_augmentation}
  \label{fig:phi_aug}}
