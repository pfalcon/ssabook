...
If-conversion implies global transformations, requiring effective region selection and reconstruction, and local code generation techniques to best select the new conditional and predicate setting operations.
...
After if-conversion the execution path is reduced to 6 cycles with no branches, regarless of the test outcome, and assuming a very optimistic 1 cycle branch penalty. 
