...
bits include exception flags of the IEEE~754 arithmetic, of the integer overflow
...
simple IR instruction, can be refined by the execution context: inclusion in
some control region; properties of operand values determined by dataflow
analysis.
