...
such as when moving code above a branch
\cite{Lowney:1993:JS} or promoting predicates \cite{Mahlke:1995:ISCA}.
...
The proposed algorithm restristing to acyclic regions with single entry and multiple exits

\end{itemize}

The evolution of if-conversion
