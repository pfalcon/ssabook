...
Early contributions to if-conversion
...
support aimed at removing conditional register writes from the processor
micro-architecture. This includes SELECT instructions called 'phi-ops',
...
instructions. The key contribution from this work is the generation of
'phi-ops', whose insertion points are computed like the placement of the SSA
...
\end{itemize}
Recent contributions to if-conversion accept the SSA
...
ordered in dominance order. TBD
