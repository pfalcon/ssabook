...
Lx/ST200 VLIW family~\cite{Faraboschi:2000:ISCA}\cite{Dinechin:2007:MISTA,Dinechin:2008:EuroPar,Boissinot:2008:CGO,boissinot09revisiting,Boissinot:2011:APLAS}.
...
et al.~\cite{boissinot09revisiting} clarified how to convert the transformed SSA\index{transformed SSA, T-SSA}
...
Boolean guards accordingly. As this work pre-dates the Program Dependence Graph\index{program dependence graph}~\cite{ferrantePDG} (see Chapter~\ref{chapter:vsdg}), complexity of the resulting Boolean expressions is
