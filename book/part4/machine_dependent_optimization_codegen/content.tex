...
implicitly assumes that all non-move operations can be speculated and is
apparently restricted to innermost if-then-else constructs.
...
speculates operations, reduces height of predicate computation, and perform tail
duplication.  A generalization is described in Chapter~\ref{chap:if_conv}.
