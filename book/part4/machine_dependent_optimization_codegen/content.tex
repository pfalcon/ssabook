...
the way these predicates are computed. The algorithm is in principle able to
processe cyclic and irreducible rooted flow graphs, but it practice it is
applied to single entry acyclic regions.

\item Blickstein \cite{Blickstein:1992:DTJ}

\item Lowney et al. \cite{Lowney:1993:JS}
