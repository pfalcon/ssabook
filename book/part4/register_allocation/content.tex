...
\end{enumerate}
This leads to Algorithm~\ref{ra:code:initloop} where $B.\texttt{livein}$ represent the set of live-in variables of $B$ and $L.\maxlive$ is the maximal register pressure in the whole loop $L$.
