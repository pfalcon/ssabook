...
The key to understanding that property is to picture the dominance-tree, with live-ranges are sub-trees of this tree.
...
On Figure~\ref{sub:ra:running-SSA}, variables $y_1$, $y_2$, $y_3$ and $x_3$ are such all ``leaf'' variables ($\regs=3)$, each of them has no more than two neighbors.

Considering again the greedy scheme, this means each of them is a candidate for simplification.
Once removed, another variable will become the new leaf of that particular branch.
