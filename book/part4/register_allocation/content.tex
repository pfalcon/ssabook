...
In an existing graph-based allocation, SSA can bring information to better help the allocator make its spill decisions.
However, with the spilling and coloring decisions fully decoupled, encoding the information using a graph does not seem as pertinent.
...
These bring in a flow-insensitive information that a variable reside an frequently executed area, but such approximations are often too coarse to give good performance.
