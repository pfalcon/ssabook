...
Among others, the optimistic approach of Park and Moon~\cite{park2004optimistic} has been shown to be extremely competitive~\cite{Grund07,Bouchez:case08} in the context of the, somehow restricted, coalescing challenge initiated by~\cite{{Appel01}}.
\endofchapter
}
