...
\inputprogress
\label{chap:register_allocation}
...
\todo{Florent: This part does not seem to be useful, but double-check my words !}
...
\begin{itemize}
  ...
  \item Braun and Hack~\cite{BH:2009:Spill} extended Belady's algorithm to general control-flow graphs.
