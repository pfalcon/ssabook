...
Control dependence between nodes is equivalent to the post-dominance frontier on the reversed CFG. To compute $C_D$, the post dominator tree is constructed for the CFG. 
...
% TODO: Replace code with algorithm 
\begin{figure}[!ht]
\centering
