...
% Do reference to introductory chapter.
For this chapter, we assume that the reader already has familiarity with SSA and the applications that it is used for.
...
Building a PDG is a multi-stage process involving the construction of both sets of edges using repeated iterations over the postdominator tree and insertion of region nodes.
