...
The aim of this section is to introduce the $\sigma$ and parallel copies that we use, together with $\phi$-functions, to implement live-range splitting in our intermediate representation.
