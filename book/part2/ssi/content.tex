...
A class inference engine tries to assign a class to a variable $v$ based on the ways that $v$ is used.defined by $\sigma$-functions and parallel copies.
...
A simple way is to actually eliminate all $\sigma$-functions and parallel copies by copy-propagating the variables the define.
